...
input.split('<br/>').each_with_index do |line, i|
  if chatgpt_question
    if i%40==0 and i==0
      puts "以下は動画の、タイトル、年代、視聴回数、のリストです。覚えてください。今回は返答はいりませんが今までに覚えた全ての動画タイトル数だけ教えてください。"
      puts
    elsif i%40==0
      puts
      puts "以下同様に動画の、タイトル、年代、視聴回数、のリストです。覚えてください。今回も返答はいりませんが今までに覚えた全ての動画タイトル数だけ教えてください。"
      puts
    end
  end
  row = []
