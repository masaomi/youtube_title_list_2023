...
input.split('<br/>').each_with_index do |line, i|
  if i%40==0 and i==0
    ...
    puts
    puts "以下同様に動画の、タイトル、年代、視聴回数、リストです。覚えてください。今回も返答はいりませんが覚えた合計動画タイトル数だけ教えてください。"
    puts
  end
  row = []
...
puts
puts "今まで覚えた全ての動画タイトル数を教えてください。"
puts
puts "今まで覚えた動画タイトルから動画内容を類推して動画を分ける10分野（テーマ）を簡単なわかりやすい言葉でリストしてください。さらに、合計視聴回数が多い順に分野リストを並べて合計視聴回数もつけてリストしてください。"
